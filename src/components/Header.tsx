  ...
  return (
    <div className="w-full flex flex-col sm:flex-col lg:flex-row items-center md:justify-between h-25 pt-2 bg-purple-800">
        ...
        <div className="flex flex-col align-center">
          <h1 className="text-white font-bold text-7xl alfa-slab pt-2 pl-16">A.G.A.B.</h1>
          <p className="text-black font-bold text-2xl lobster pt-2 pb-3">Amics dels Gats i d'altres Animals de Balenyà</p>
        </div>
